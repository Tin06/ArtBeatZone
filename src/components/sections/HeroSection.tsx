...
export default function HeroSection() {
  ...
  return (
    <section id="intro" className="min-h-screen pt-[60px] flex flex-col border-b border-white/10 bg-black">
      ...
      <div className="flex flex-col md:flex-row border-b border-white/10">
        {stats.map(({ num, hr, en, color }, i) => (
          ...
          >
            ...
            <span className="text-[0.7rem] font-medium tracking-[0.12em] uppercase text-white/45">
              {t(hr, en)}
            </span>
          </div>
        ))}
      ...
      <div className="px-12 py-4 flex items-center gap-4 text-[0.62rem] font-semibold tracking-[0.2em] uppercase text-[#00ff88]">
        {t('Scroll za vise', 'Scroll for more')}
